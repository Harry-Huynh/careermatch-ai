      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <p className="mt-2 text-secondary">
            Track match quality and find the clearest next resume improvements.
          </p>
        </div>
        <Link
          className="inline-flex h-11 cursor-pointer items-center justify-center gap-2 rounded-[10px] bg-lime px-4 text-sm font-medium text-black hover:bg-lime/90"
          href="/jobs/new"
        >
